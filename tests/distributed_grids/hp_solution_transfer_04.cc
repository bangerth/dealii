...
void test(std::ostream & /*out*/)
{
  ...
  parallel::distributed::SolutionTransfer<dim, Vector<double>, hp::DoFHandler<dim> > soltrans(dofh);
  parallel::distributed::SolutionTransfer<dim, Vector<double>, hp::DoFHandler<dim> > soltrans2(dofh);
